        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              {step === 'verify' ? 'Back to Phone' : t('auth.backToHome')}
            </Button>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
              {step === 'phone' ? <Leaf className="w-8 h-8 text-primary-foreground" /> : <MessageCircle className="w-8 h-8 text-primary-foreground" />}
            </div>
            <h2 className="text-3xl font-bold text-foreground mb-2">
              {step === 'phone' ? t('auth.welcomeBack') : 'Verify Your Phone'}
            </h2>
